...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://prajwaludaykumar:<PASSWORD>@cluster0.vha5j.mongodb.net/mydatabase?retryWrites=true&w=majority")  # MongoDB URI for the database
